@push('stack_title_style')
    <title>Communities | Boostem</title>
    <style>
        body {
    margin: 0;
    padding: 0;
...
@section('content')
  ...
  <div class="maintenance_contain">
    ...
    <div class="pp-infobox-title-wrapper">
		  <h3 class="pp-infobox-title">This section is under maintenance!</h3>
	  </div> 
  <div class="pp-infobox-description">
		<p>Someone has kidnapped our section. We are negotiation ransom and<br>will resolve this soon</p></div>    
