@push('stack_title_style')
    <title>Edit Profile | Boostem</title>
            ...
            <aside class="col-md-4">
                <div class="mb-3 border rounded bg-white profile-box text-center w-10">
                    <div class="p-4 d-flex align-items-center">
                        @if(Auth::user()->profile_photo_path == null) <img src="{{ asset('public/icons/user-img.png') }}" class="img-fluid rounded-circle" alt="{{ Auth::user()->name }}">
                  @else <img src="{{ Auth::user()->profile_photo_path }}" class="img-fluid rounded-circle" alt="{{ Auth::user()->name }}">
                  @endif
                ...
                <div class="border rounded bg-white mb-3">
                    ...
                    <div class="box-body">
                        ...
                        <div class="overflow-hidden text-center p-3">
                            <a class="font-weight-bold btn btn-light rounded p-3 d-block" href="#"> Update
                                Social Profiles </a>
                        </div>
                    </div>
                </div>
