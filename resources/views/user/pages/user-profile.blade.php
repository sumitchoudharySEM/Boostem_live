@push('stack_title_style')
    <title>Profile | Boostem</title>

    <link rel="stylesheet" type="text/css" href="{{ asset('public/profileTemp/vendor/slick/slick.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('public/profileTemp/vendor/slick/slick-theme.min.css') }}" />
    <link href="{{ asset('public/profileTemp/vendor/icons/feather.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('public/profileTemp/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('public/profileTemp/css/style.css') }}" rel="stylesheet">
@endpush
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    <div class="py-4 px-3 border-bottom">
                        @if(Auth::user()->profile_photo_path == null) <img src="{{ asset('public/icons/user-img.png') }}" class="img-fluid mt-2 rounded-circle" alt="{{ Auth::user()->name }}">
                        @else <img src="{{ Auth::user()->profile_photo_path }}" class="img-fluid mt-2 rounded-circle" alt="{{ Auth::user()->name }}">
                        @endif
                    ...
                    <div class="overflow-hidden border-top">
                        <a class="font-weight-bold p-3 d-block" href="{{ url('logout') }}"> Log Out </a>
                    </div>
                </div>
                    ...
                    <div class="box-body">
                        <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                            ...
                            <div class="font-weight-bold">
                                ...
                                <div class="small text-muted"><span class="text-primary">You and 1
                                        connection</span> have given endorsements for this skill
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        ...
                        <p class="mb-0">Find the most qualified people in the most unexpected places. Information
                            for applicants to consider when applying for local positions. The largest community on
                            the web to find and list jobs that aren't restricted by commutes or a specific location.
                        </p>
                    </div>
                </div>
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        ...
                        <p class="mb-0">Find the most qualified people in the most unexpected places. Information
                            for applicants to consider when applying for local positions. </p>
                    </div>
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            <div class="mr-2">
                    ...
                    <div class="box-body p-3">
                        ...
                        <p class="mb-0">Wualified people in the most unexpected places. Information for
                            applicants to consider when applying for local positions. The largest community on the
                            web to find and list jobs that aren't restricted by commutes or a specific location.
                        </p>
                    </div>
                </div>
                <div class="box shadow-sm border rounded bg-white mb-3">
...
@push('child_script')
<script src="{{ asset('public/profileTemp/vendor/jquery/jquery.min.js') }}" type="b4569b44535e113e2d6bd7ab-text/javascript"></script>
<script src="{{ asset('public/profileTemp/vendor/bootstrap/js/bootstrap.bundle.min.js') }}" type="b4569b44535e113e2d6bd7ab-text/javascript"></script>

<script type="b4569b44535e113e2d6bd7ab-text/javascript" src="{{ asset('public/profileTemp/vendor/slick/slick.min.js') }}"></script>

<script src="{{ asset('public/profileTemp/js/osahan.js') }}" type="b4569b44535e113e2d6bd7ab-text/javascript"></script>
{{-- <script src="{{ asset('public/profileTemp/') }}../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
    data-cf-settings="b4569b44535e113e2d6bd7ab-|49" defer=""></script> --}}
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
    integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw=="
    data-cf-beacon='{"rayId":"75ca6b237ce87938","version":"2022.10.3","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}'
